...
from ..models import TranscriptionResult, Segment, TranscriptionInfo  # Adjust the import path
import whisper
import asyncio
import aiofiles
import tempfile
...
async def transcribe_audio_file(file: UploadFile) -> TranscriptionResult:
    ...
    try:
        ...
        info = TranscriptionInfo(
            ...
            language_probability=result.get("language_probability", 1.0),  # Placeholder probability
        ...
        os.remove(temp_file_path)  # Ensure the temporary file is deleted after processing
